        ...
        <div className=" flex flex-col items-center justify-center rounded border border-gray-800 px-10 py-20 bg-[#0E131E]">
            ...
            <div className="mb-6">
                <form className="" onSubmit={handleSubmit(formSubmit)}>
                    ...
                    <div>
                        <button className="relative w-100 bg-[#0077FF] py-3 rounded-lg font-medium" disabled={isSubmitting}>{isSubmitting ? 'submitting....' : 'Sign in'}
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="absolute top-3 left-59  size-6">
            ...
            <div>
                <p className="text-center">Don't have an account? <span onClick={handleClick} className="cursor-pointer text-[#0077FF]">Sign Up</span></p>
            </div>
