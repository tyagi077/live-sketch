    ...
    <div className="flex flex-col items-center justify-center rounded border border-gray-800 px-10 py-20 bg-[#0E131E]">
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
          <div className="my-4">
            ...
            <div className={`${errors.Email && 'border border-red-600'} bg-[#151D2C] mt-2 rounded-lg`}>
              <input
                className="focus:outline-none w-100 p-3 rounded-lg text-white"
          ...
          <div className="my-4">
            ...
            <div className={`${errors.password && 'border border-red-600'} bg-[#151D2C] mt-2 rounded-lg`}>
              <input
                className="focus:outline-none w-100 text-white p-3 rounded-lg"
                placeholder="......."
          ...
          <div>
            <button
              className="relative w-100 bg-[#0077FF] py-3 rounded-lg font-medium"
      ...
      <div>
        <p className="text-center">
          ...
          <span onClick={handleClick} className="cursor-pointer text-[#0077FF]">
            Sign Up
          </span>
        </p>
      </div>
